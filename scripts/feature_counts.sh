...
featureCounts -p -C -s 0 -Q 25 -T 4 --tmpDir $SCRATCH -a Homo_sapiens.GRCh38.108.gtf -G Homo_sapiens.GRCh38.dna.primary_assembly.fa -o ${sample[$SLURM_ARRAY_TASK_ID]}_featureCounts_output.txt sorted_${sample[$SLURM_ARRAY_TASK_ID]}.bam
